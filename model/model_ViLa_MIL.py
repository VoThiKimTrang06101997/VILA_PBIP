# model_ViLA_MIL.py (Fixed: Replaced BiomedCLIP with ResNet-50 for feature extraction. Removed MedCLIP/BiomedCLIP entirely. Updated forward to handle shapes. Added dynamic num_patches. Fixed CAM generation. Ensured clamping. Adjusted losses.)
...
class ViLa_MIL_Model(nn.Module):
    def __init__(self, config, num_classes=4):
        ...
        # Use ResNet-50 for feature extraction (replacing BiomedCLIP/MedCLIP)
    ...
    def forward(self, x, labels=None, fg_bg_labels=None, coords=None, cfg=None, img_name=None):
        ...
        # Multi-scale CAMs with 5 classes
